          ...
          {NAV.map((item) => {
            ...
            return (
              <div key={item.href} className="relative group">
                <Link
                  href={item.href}
                  className={`flex items-center gap-2.5 px-2 py-2 rounded-lg text-[13px] font-semibold transition-all ${
                ...
                {collapsed && (
                  <div className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-2.5 z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
