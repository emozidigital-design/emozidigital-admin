...
const SECTIONS = [
  ...
  { href: "/email/tags",         label: "Tags",                 desc: "Contact groups for targeting",               icon: "M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" },
  { href: "/email/newsletters",  label: "Newsletter / Campaign", desc: "Create and manage all email sends",         icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" },
  { href: "/email/transactional", label: "Transactional",       desc: "API-triggered single sends (logs only)",     icon: "M13 10V3L4 14h7v7l9-11h-7z" },
  { href: "/email/statistics",   label: "Statistics",           desc: "Opens, clicks, bounces & send trends",       icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
]
  ...
  return (
    <div className="w-full">
      <div className="mb-8">
        ...
        <p className="text-sm text-zinc-500 mt-1">Manage newsletters, campaigns, contacts, and statistics via AWS SES</p>
      </div>
